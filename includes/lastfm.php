...
$user = "faooful"; // <---- Your username goes here
$key = "0c7aa45bdec000970ca52a5a18b0313c"; //<-- Your API key goes here
...
if (isset($last['@attr']['nowplaying'])) {
        ...
        $output = "<i class=\"icon-headphones\"></i> I am currently listening to {$last['name']} by {$last['artist']['#text']}";
